...
1. lit la version active (`tools/EvidenceForge/ACTIVE_VERSION`, aujourd'hui `MONOLITH-v1.0.9` (candidat = v1.0.8 (streaming validé en réel) + proxy v0.8 délais séparés, correctif 504 à 8 s)) ;
...
Diagnostic fournisseur (`MONOLITH-v1.0.9/lib/provider-diagnostic.js`, inchangé depuis v1.0.5) : trois niveaux — `credentialsPresent` (présents, sans placeholder,
...
cd tools/EvidenceForge/r6/EvidenceForge-CLEAN-MONO-01-08/MONOLITH-v1.0.9
