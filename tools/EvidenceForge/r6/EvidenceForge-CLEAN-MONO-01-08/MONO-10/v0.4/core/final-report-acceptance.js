"use strict";
/**
 * MONO-10 v0.4 — core/final-report-acceptance.js  (§22)
 *
...
function buildAcceptanceTemplate(report, opts) {
  ...
  return {
    ...
    schema: "EvidenceForge.FinalReportAcceptance", schemaVersion: "MONO-10-v4",
    ...
    decision: null, reservationsAcknowledged: [], actorType: null, actorIdentity: null, decidedAt: null, authenticationMode: null,
  };
}

function validateAcceptance(acceptance, report, ctx) {
  ctx = ctx || {};
  const problems = [];
  ...
  const auth = verifyHumanActAuthenticity(acceptance, { executionMode: RM.effectiveMode(ctx),
    humanActVerifier: ctx.humanActVerifier, allowTestFixtureActs: ctx.allowTestFixtureActs, manifest: ctx.manifest }, "FinalReportAcceptance");
