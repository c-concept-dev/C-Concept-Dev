...
MONO-01 → MONO-09 sont **GELÉS**. MONO-10 v0.1, v0.2 et v0.3 sont **HISTORIQUES
et immuables**. v0.4 est un lot **successeur**.

MONO-10 v0.3 a été déclaré `NON_GELABLE` par l'audit A. Ce jugement **reste**
celui qui a été porté, sur ce lot-là, à ce moment-là. v0.4 ne le réhabilite pas :
elle lui succède.
...
**Comparaison avant / après travaux v0.4 : identique, 16 lots sur 16.**

## 4. Trois constats distincts — *unknown remains unknown*

| Constat | Valeur | Fondement |
|---|---|---|
| `MONO10_V04_CAUSED_REGRESSION` | **NO** | baseline agrégée identique avant/après ; 7 lots à 0 divergent contre leurs manifestes scellés ; aucun fichier créé ou modifié hors de `MONO-10/v0.4/` |
| `FULL_HISTORY_BYTE_IDENTITY_CONFIRMED` | **NO** | seuls 7 lots sur 16 portent une référence autoritaire scellée |
