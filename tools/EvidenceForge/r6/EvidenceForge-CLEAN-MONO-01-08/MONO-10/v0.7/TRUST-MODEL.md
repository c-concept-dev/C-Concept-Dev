# MONO-10 v0.7 — modèle de confiance
...
| **v0.7** | ce qui précède **et** la dérivation depuis des preuves authentifiées | hypothèse §7 ci-dessous |
...
registre de racines de provenance, registre d'entrées historiques, racine de
réserve anti-rejeu — obtient une frontière de PRODUCTION.**

v0.7 élargit la surface provisionnée par l'exploitant : elle couvre maintenant
les racines de provenance et les entrées historiques. Cela **déplace** de la
confiance vers l'exploitant ; cela ne la supprime pas, et la liste ci-dessus est
exhaustive à dessein.
