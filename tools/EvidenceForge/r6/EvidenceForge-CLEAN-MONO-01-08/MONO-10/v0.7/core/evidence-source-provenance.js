"use strict";
/**
 * MONO-10 v0.7 — core/evidence-source-provenance.js   (§32, §33, §34)
 *
...
function resolveEvidenceSourceProvenance(evidence, registry, opts) {
  ...
  const authority = opts.provenanceAuthority
    || (opts.verifier && typeof opts.verifier.provenanceAuthority === "function" ? opts.verifier.provenanceAuthority() : null);
  if (!OPA.isProvisionedProvenanceAuthority(authority)) {
    return { status: PROVENANCE_STATUS.UNRESOLVED, sourceRootId: null, authorityRootId: null, familyRootId: null,
