"use strict";
/**
 * MONO-10 v0.7 — adapters/upstream-evidence-binder.js   (§17 a §25, §32)
 *
 * FERMETURE B5 et B6.
 *
...
function createUpstreamEvidenceBinder(input) {
  ...
  const authority = OPA.isProvisionedProvenanceAuthority(input.provenanceAuthority) ? input.provenanceAuthority
    : (input.verifier && typeof input.verifier.provenanceAuthority === "function"
      ? (OPA.isProvisionedProvenanceAuthority(input.verifier.provenanceAuthority()) ? input.verifier.provenanceAuthority() : null)
      : null);
