"use strict";
/**
 * MONO-10 v0.8 — core/panel-gated-adapter.js  (§3, §4, §5, §30)
 *
...
const GATE_ID = "MONO-10-v8-panel-gate";
  ...
  function gate() {
    ...
    if (reg && typeof reg.get === "function") {
      ...
      AC.assertCapability(entry, required, "panel-gated-adapter:corpus-sink",
        (opts.runContext || {}).manifest ? opts.runContext.manifest.operatorTrustBoundaryId : null);
    }
