"use strict";
/**
 * MONO-10 v0.7 — validators/index.js
...
const OHIA = require("../core/operator-historical-input-authority.js");
const CAG = require("../core/caller-assertion-guard.js");
...
module.exports = {
  ...
  capabilities: { CAPABILITY: AC.CAPABILITY, SINK_REQUIREMENTS: AC.SINK_REQUIREMENTS,
    mintCapabilityGrant: AC.mintCapabilityGrant, isCapabilityGrant: AC.isCapabilityGrant,
    assertCapability: AC.assertCapability, hasCapability: AC.hasCapability, requirementOf: AC.requirementOf },
  contracts: { values: CC.values, verifyDocumentedContract: CC.verifyDocumentedContract,
    CONTRACT_SOURCE_HASH: CC.CONTRACT_SOURCE_HASH, DOCUMENTED_CONTRACTS: CC.DOCUMENTED_CONTRACTS },
  provenanceAuthority: { isProvisionedProvenanceAuthority: OPA.isProvisionedProvenanceAuthority, STATUS: OPA.STATUS },
  historicalInput: { isProvisionedHistoricalInputAuthority: OHIA.isProvisionedHistoricalInputAuthority,
    isHistoricalInputAuthorization: OHIA.isHistoricalInputAuthorization, BOUND_FIELDS: OHIA.BOUND_FIELDS },
  callerAssertionGuard: { sanitizeByAllowlist: CAG.sanitizeByAllowlist,
    assertNoAuthorityAssertion: CAG.assertNoAuthorityAssertion, REFUSAL: CAG.REFUSAL },
