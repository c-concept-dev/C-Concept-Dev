...
| Article | Exigence | Où elle s'exerce dans v0.8 |
|---|---|---|
...
| §22 | la non-régression est exécutée, pas racontée | `test/test-mono10-v0.8.js` — `NR-01`, `NR-02` |
...
| §17 | fail closed, jusque dans les API publiques de validation | `core/scientific-readiness.js` — registre et liaisons obligatoires |
