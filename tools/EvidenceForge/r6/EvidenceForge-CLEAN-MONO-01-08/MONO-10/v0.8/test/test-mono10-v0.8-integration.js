...
"use strict";
/**
 * MONO-10 v0.8 — integration HORS LIGNE (§42, §43, §54, §55).
 *
...
(async () => {
  console.log("MONO-10 v0.8 — integration hors ligne (vrai consumer MONO-09 v0.2, mode TEST)\n");
  ...
  async function scenario(o) {
    ...
    const intent = { runId, missionHash, producerId: "MONO-10", producerVersion: "v0.8",
    ...
    registry.grantCapability("panel-validation", AC.mintCapabilityGrant({ issuer: mech,
      ...
      operatorBoundaryId: boundary.operatorTrustBoundaryId, issuerId: mech.mechanismId,
  ...
  check("I-30. une autorite parallele n'emet aucune capacite sur ce run",
    capErr === "CAPABILITY_ISSUER_INVALID", capErr);
