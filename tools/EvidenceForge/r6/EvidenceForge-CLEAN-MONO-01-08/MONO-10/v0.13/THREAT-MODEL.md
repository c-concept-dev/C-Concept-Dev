# MONO-10 v0.13 — modèle de menace
...
## 7. Ce que ce modèle de menace ne couvre PAS (corrections v0.12 et v0.13)

### Note sur les étiquettes de réserve

Deux séries d'étiquettes coexistent dans ce document, et les confondre a
produit une ambiguïté que v0.13 corrige :
...
**Treize champs de l'artefact de capacité LLM ne sont pas attestés**, et le
...
complète : `LLM-CAPABILITY-BOUNDARY.md`, « Champs non attestés ».
