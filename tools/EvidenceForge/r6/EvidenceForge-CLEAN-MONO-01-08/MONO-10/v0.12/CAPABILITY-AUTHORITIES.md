...
| `certifyLlmCapability({registry, artifactId})` | un verdict, sur le **sujet exact** de l'artefact ; `LLM_SUBJECT_MISMATCH`, `LLM_SUBJECT_OUT_OF_ALLOWLIST`, `LLM_PROBE_ALREADY_CONSUMED` |
