# MONO-10 v0.12 — confiance du registre d'artefacts
...
| **Non attesté** | le **reste du contenu de l'artefact**. Treize champs informatifs sont déclarés par l'appelant et jamais recoupés, et le schéma n'est pas fermé à l'enregistrement |
...
`OPEN-FINDINGS-v0.12.md` (R1 et R3).
