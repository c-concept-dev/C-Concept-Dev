...
| la liste blanche s'appliquait à la sonde seule | elle est **ré-appliquée à la certification** — `LLM_SUBJECT_OUT_OF_ALLOWLIST` |
...
`LLM_SUBJECT_OUT_OF_ALLOWLIST`, `LLM_PROBE_ALREADY_CONSUMED`,
