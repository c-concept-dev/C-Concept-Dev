...
Ce tableau décrit **l'état courant du lot MONO-10 v0.15**, sauf mention
...
| Article | Exigence | Où elle s'exerce — état courant v0.15 |
|---|---|---|
...
**non corrigées par v0.15**. Ce document ne doit jamais être lu comme une
