"use strict";
/**
 * MONO-10 v0.5 — core/effective-eligibility.js   (§21, §22, §23)
 *
...
function deriveEffectiveEligibility(input) {
  ...
  const out = {
    schema: "EvidenceForge.EffectiveCorpusEligibility", schemaVersion: "MONO-10-v5",
    ...
    recomputed: true, evidenceRefs: refs, policy: policy,
...
function isEligible(e) {
  // §21/§22 — on ne lit jamais un champ fourni : on exige la marque de recalcul.
  if (!e || e.recomputed !== true) return false;
