"use strict";
/**
 * MONO-10 v0.5 — core/llm-capability.js  (§19)
 *
...
async function runActiveProbe(config, transport, ctx) {
  ...
  const base = {
    schema: "EvidenceForge.LlmCapability", schemaVersion: "MONO-10-v5",
...
function classifyLegacyDeclaration(dependenciesAvailable) {
  return { schema: "EvidenceForge.LlmCapability", schemaVersion: "MONO-10-v5",
