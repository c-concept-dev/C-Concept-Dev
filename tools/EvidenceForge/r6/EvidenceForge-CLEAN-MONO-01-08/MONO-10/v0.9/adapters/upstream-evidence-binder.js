"use strict";
/**
 * MONO-10 v0.9 — adapters/upstream-evidence-binder.js   (§17 a §25, §32)
 *
 * FERMETURE B5 et B6.
 *
    ...
    if (authority) {
      ...
      if (resolved.status === CC.PROVENANCE_STATUS.AUTHENTICATED) {
        ...
        const grant = AC.mintCapabilityGrant({ issuer: authority, capability: AC.CAPABILITY.AUTHENTICATED_PROVENANCE,
          ...
          /** §4 (v0.9) — la liaison de configuration est nommee, donc comparable. */
          configBindingHash: manifest.configBindingHash,
