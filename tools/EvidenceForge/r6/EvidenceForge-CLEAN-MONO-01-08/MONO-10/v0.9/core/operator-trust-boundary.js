"use strict";
/**
 * MONO-10 v0.9 — core/operator-trust-boundary.js   (§2, §3, §4, §6, §7, §8)
 *
 * ================================================================
...
/**
 * MONO-10 v0.9 — §3, §5, §6 : RACINE UNIQUE D'AUTORITE.
 *
...
function buildBoundary(cfg, namespace, provisionedFrom, sourceDescriptor) {
  ...
  return sealBoundary({
    schema: "EvidenceForge.OperatorTrustBoundary", schemaVersion: "MONO-10-v9",
