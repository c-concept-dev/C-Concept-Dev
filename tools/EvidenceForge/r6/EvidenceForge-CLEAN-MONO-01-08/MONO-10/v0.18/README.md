# MONO-10 v0.18 — DOC-19 CAUSAL STALE-STATUS FIX
...
Un successeur **strictement documentaire** de v0.17 — qui l'était de v0.16, de
v0.15, de v0.14, de v0.13, de v0.12 et de v0.11.
...
**et** `RUNTIME_BYTE_IDENTICAL_TO_V017 = YES`, vérifiables en quatre-vingt-quatre
`diff` (douze chemins × sept lots, `NON-REGRESSION.md` §1). La **Charte** reste
byte-identique.

## Pourquoi il existe

Huit audits indépendants se sont succédé. Les deux premiers ont conclu que
...
documents affirmaient le contraire. Toujours **sans aucun bloqueur runtime**.
...
| — | `MANIFEST.correctedStatements` B2 | un seul `where` mêlant la faute exacte et les recadrages préventifs | `historicalFaultLocation`, `preventiveReframings`, `fixLocation` distingués |

Détail : `MIGRATION-v0.17-v0.18.md`. Registre des verdicts : `AUDIT-VERDICTS.v0.12-v0.18.md`.
...
| `RUNTIME_BYTE_IDENTICAL_TO_V017` | **YES** (12 chemins) — 84 comparaisons vides au total |
...
| `SEALED_HISTORICAL_LOTS_COUNT` | **24** cadre v0.11 · **25** cadre v0.12 · **26** cadre v0.13 · **27** cadre v0.14 · **28** cadre v0.15 · **29** cadre v0.16 · **30** cadre v0.17 · **31** cadre v0.18 |
| `SEALED_REFERENCES_COUNT` | **1 577** cadre v0.11 · **1 644** cadre v0.12 · **1 715** cadre v0.13 · **1 787** cadre v0.14 · **1 860** cadre v0.15 · **1 934** cadre v0.16 · **2 010** cadre v0.17 · **2 087** cadre v0.18 |
| `ALL_SEALS_FILE_COUNT` / `ALL_SEALS_REFERENCE_COUNT` | **42** / **3 648**, arbre complet au scellement de v0.18, mesuré après scellement (`NON-REGRESSION.md` §2) |
| `BUILD_WINDOW_OPENED` (v0.18) | dérivé, jamais saisi : `NON-REGRESSION.md` §7, `MANIFEST.sealInventory.v018BuildWindowOpened`, contrôle `DOC-20` |
| Provenance documentaire | mesurée sur les dix-sept lots scellés : `MANIFEST.originTitledDocuments` (9 documents à titre d'origine, dont 2 à origine de contenu v0.10) et `MANIFEST.documentHistory` (tous les `.md`), contrôles `DOC-24`, `DOC-27`, `RT-08` |
...
| Réserves ouvertes consignées | **5** (R1–R5), toutes `OPEN` / `NON_BLOCKING` / `NOT_FIXED_IN_V018` |
...
4. **Neuf divergences de sceau subsistent** dans `MONO-07` et `MONO-08/v0.6`.
   v0.18 ne les corrige pas. (`OPEN-FINDINGS.md` R4)
...
4. La garde de contrats couvre des **énumérations**, pas la prose
   ...
   `test/test-mono10-v0.18-documentary.js` en couvre désormais vingt-six,
...
`OPEN-FINDINGS.md` **d'abord** → `MIGRATION-v0.17-v0.18.md` → `MIGRATION-v0.16-v0.17.md` →
`MIGRATION-v0.15-v0.16.md` → `MIGRATION-v0.14-v0.15.md` → `MIGRATION-v0.13-v0.14.md` →
`MIGRATION-v0.12-v0.13.md` → `MIGRATION-v0.11-v0.12.md` → `AUDIT-VERDICTS.v0.12-v0.18.md` →
