# MONO-10 v0.18 — registre des verdicts d'audit (v0.12 à v0.18)
...
nom contient volontairement des points (`AUDIT-VERDICTS.v0.12-v0.18.md`) : le
...
| v0.18 | *à rendre par l'audit final de v0.18* | — | — | — |
