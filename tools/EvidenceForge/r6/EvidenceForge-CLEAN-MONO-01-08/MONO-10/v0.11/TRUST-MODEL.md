# MONO-10 v0.11 — modèle de confiance
...
| **v0.11** | ce qui précède **et** la **liaison de la décision au sujet exact certifié**, aucun contrôle ne se désactivant par omission | hypothèse §7 ci-dessous |
