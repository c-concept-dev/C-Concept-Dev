...
|---|---|---|
| 1 | **continuité adjacente** : « depuis », « encore », « toujours », « à ce jour », « aujourd'hui », « reste », « demeure », « désormais » — immédiatement après le token (ponctuation, « est », « et », « c'est » tolérés entre les deux) ou immédiatement avant lui | `FAIL`, quel que soit le contexte (citation comprise). *Claim de v0.18 invalidée par l'audit final de v0.18 : avant le token, le motif de v0.18 utilisait `\b`, qui ne précède jamais « à », et omettait « depuis » — 26/32 mesurés. Corrigé en v0.19 (`MIGRATION-v0.18-v0.19.md` §1), où la promesse devient vraie pour les huit mots des deux côtés* |
