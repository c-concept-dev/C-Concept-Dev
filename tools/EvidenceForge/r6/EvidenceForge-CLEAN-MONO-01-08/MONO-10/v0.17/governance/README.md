...
Ce tableau décrit **l'état courant du lot MONO-10 v0.17**, sauf mention
...
| Article | Exigence | Où elle s'exerce — état courant v0.17 |
|---|---|---|
...
**non corrigées par v0.17**. Ce document ne doit jamais être lu comme une
