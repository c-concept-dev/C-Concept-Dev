# MONO-10 v0.17 — registre des verdicts d'audit (v0.12 à v0.17)
...
nom contient volontairement des points (`AUDIT-VERDICTS.v0.12-v0.17.md`) : le
...
| v0.16 | `NON_GELABLE` | 0 | deux titres d'origine faux (contenu de v0.10 sous un H1 v0.7, `RT-08` ne comparant qu'à v0.11) ; un statut périmé « `NOT_FIXED_IN_V015` depuis » | v0.17 |
| v0.17 | *à rendre par l'audit final de v0.17* | — | — | — |
...
| v0.17 | provenance **mesurée** contre le lot nommé (origine conceptuelle ≠ origine de contenu) ; historique de chaque document mesuré ; ancien token de statut toléré seulement « à l'époque de v0.NN » ; bornes de heading et de colonne indépendantes ; énumérations comparées comme ensembles ; négation lue comme négation |
