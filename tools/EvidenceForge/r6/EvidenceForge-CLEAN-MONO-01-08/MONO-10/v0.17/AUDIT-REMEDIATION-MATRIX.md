# MONO-10 v0.17 — matrice de remédiation (v0.12 à v0.17 : lots documentaires)
...
## 11. v0.15 à v0.17 — ce que les audits finaux de v0.14, v0.15 et v0.16 ont établi

Même constante : aucun bloqueur runtime, runtime byte-identique. Les trois audits
ont rendu `NON_GELABLE` pour des résidus documentaires — le deuxième a montré
qu'un témoin causal peut passer **pour une mauvaise raison** (`DOC-03`), le
troisième qu'un titre de version **se mesure** contre le lot qu'il nomme, il ne
se croit pas.

| Constat | Établi par | Statut en v0.17 |
|---|---|---|
...
| B2 (v0.16) : `MIGRATION-v0.13-v0.14.md` « `NOT_FIXED_IN_V015` depuis » — ancien token présenté comme courant | audit final de v0.16 | **corrigé en v0.17** : « à l'époque de v0.NN : `NOT_FIXED_IN_V0NN` ; statut courant dans `OPEN-FINDINGS.md` » dans les trois migrations concernées ; `DOC-19` n'accepte un ancien token que dans la phrase « à l'époque de v0.NN » (même NN) et refuse « depuis » |
