# MONO-10 v0.16 — matrice de remédiation (v0.12 à v0.16 : lots documentaires)
...
## 11. v0.15 et v0.16 — ce que les audits finaux de v0.14 et de v0.15 ont établi

Même constante : aucun bloqueur runtime, runtime byte-identique. Les deux audits
ont rendu `NON_GELABLE` pour des résidus documentaires — et le second a montré
qu'un témoin causal peut passer **pour une mauvaise raison** (`DOC-03`).

| Constat | Établi par | Statut en v0.16 |
|---|---|---|
