...
| 14 lots scellés, 514 références | **24** lots, **1 577** références (cadre v0.11) |
...
| Fichier | Changement |
|---|---|
| `OPEN-FINDINGS.md` | **nouveau** — les cinq réserves R1–R5, aucune présentée comme résolue |
...
| `test/test-mono10-v0.12-documentary.js` | **nouveau** — contrôles qui échouent si une fausseté documentaire réapparaît. *Fichier de v0.12, remplacé depuis* : `test/test-mono10-v0.13-documentary.js` en v0.13, puis `test/test-mono10-v0.14-documentary.js` en v0.14 |
