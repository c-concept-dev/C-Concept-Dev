# MONO-10 v0.10 — correspondance contrats ↔ modules
...
| `operator-llm-capability-boundary.js` | `recordProbe` ; `LLM_PROBE_EXECUTION` |
...
| `llm-capability.js` | frontière injectée par la frontière ; `probeDerivationRef` ; bloc de production non contournable |
| `scientific-readiness.js` | identité composite ; mode d'exécution authentifié ; registre de TEST refusé en PRODUCTION |
