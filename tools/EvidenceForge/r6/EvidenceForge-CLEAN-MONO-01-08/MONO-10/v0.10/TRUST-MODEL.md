# MONO-10 v0.10 — modèle de confiance
...
| **v0.10** | ce qui précède **et** la **dérivation vérifiable auprès de l'émetteur**, l'émetteur n'étant plus remis à l'appelant | hypothèse §7 ci-dessous |
