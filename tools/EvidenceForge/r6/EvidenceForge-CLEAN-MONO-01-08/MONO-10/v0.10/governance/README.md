...
| Article | Exigence | Où elle s'exerce dans v0.10 |
|---|---|---|
...
| §22 | la non-régression est exécutée, pas racontée | `test/test-mono10-v0.10.js` — `NR-01`, `T33` |
...
| §24 | aucune dette bloquante silencieuse | `README.md` — cinq hypothèses déclarées, et **B1-B consigné comme non reproduit** plutôt que comme fermé |
