"use strict";
/**
 * MONO-10 v0.10 — core/operator-trust-boundary.js   (§2, §3, §4, §6, §7, §8)
 *
 * ================================================================
...
/**
 * MONO-10 v0.10 — §3, §5, §6 : RACINE UNIQUE D'AUTORITE.
 *
...
function buildBoundary(cfg, namespace, provisionedFrom, sourceDescriptor) {
  ...
  const sealed = sealBoundary({
    schema: "EvidenceForge.OperatorTrustBoundary", schemaVersion: "MONO-10-v10",
