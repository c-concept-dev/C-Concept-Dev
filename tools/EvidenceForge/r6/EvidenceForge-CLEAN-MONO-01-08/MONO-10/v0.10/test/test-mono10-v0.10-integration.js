...
"use strict";
/**
 * MONO-10 v0.10 — integration HORS LIGNE (§42, §43, §54, §55).
 *
...
(async () => {
  console.log("MONO-10 v0.10 — integration hors ligne (vrai consumer MONO-09 v0.2, mode TEST)\n");
   ...
   * avec un `probeDerivationRef` inventee et l'enregistre reellement.
   */
  ...
  const capN3 = { schema: "EvidenceForge.LlmCapability", schemaVersion: "MONO-10-v6", status: "AVAILABLE",
    ...
    probeDerivationRef: "decision:llm_probe_execution:jamais-executee" };
