...
```
node test/test-monolith.js          # 38 tests : intégrité, mission, screening, ratification, LLM (fail-closed, credit, 429, timeout, réseau, reuse), rapport, pipeline, serveur, UI, anti-hardcoding, secrets
