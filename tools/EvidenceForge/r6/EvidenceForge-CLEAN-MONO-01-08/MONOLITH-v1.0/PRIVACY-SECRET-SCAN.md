# PRIVACY-SECRET-SCAN — MONOLITH v1.0
...
## Scan (mesuré le 2026-09-14, `node tools/secret-scan.js`)

```
{ "ok": true, "filesScanned": 35, "envValuesChecked": ["EVIDENCEFORGE_WORKER_API_KEY","LLM_WORKER_BASE_URL"], "hits": [] }
```
