# FROZEN-INTEGRITY — MONOLITH v1.0
...
| MONO-11 v0.2 (GELÉ) | `MONO-11/v0.2` | 30 | 0 | `57e243b785f8de8c0bc603933162f1df160085f92061a13a43d3d2d243eb9df3` | `5c208cbbd13231e732fe20475347f9f7cbe6f890f3ce4823581093c7eba60005` | oui |
...
Le sceau MONO-11 v0.2 mesuré (`57e243b7…9df3`) est identique au `runtimeSealSha256` du run P0.1 seal B (`P0.1-RUN-STATE-PHASE2-V02.json`) et au sceau consigné par la décision de gel (`EvidenceForge-MONO11-v0.2-FREEZE-DECISION.md`). Le garde gelé `run-seal-guard.assertSealedRuntime` est le premier appel avant tout `require` du lot MONO-11 (test I3/I4).
