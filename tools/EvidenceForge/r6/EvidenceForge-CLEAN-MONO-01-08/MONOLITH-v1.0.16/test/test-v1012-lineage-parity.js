...
module.exports = async function (h) {
  ...
  await T("V12-18", "version du produit et frontiere : config MONOLITH-v1.0.16, lot MONO-11 v0.4 ; le monolithe ne fabrique aucun prompt de revue (hors adaptateur EF-03B) ; lots geles 0 divergence", () => {
    assert((P.CONFIG.product.version) === ("MONOLITH-v1.0.16")); assert((P.CONFIG.frozenLots["MONO-11"].dir) === ("MONO-11/v0.4"));
