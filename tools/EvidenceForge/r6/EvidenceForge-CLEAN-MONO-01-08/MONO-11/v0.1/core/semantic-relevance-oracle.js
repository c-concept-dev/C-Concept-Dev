"use strict";
/**
 * MONO-11 v0.1 — core/semantic-relevance-oracle.js   (audit §9 G-3)
 *
...
function recordedLlmCall(llmCall, calls, meta) {
  return async function (prompt) {
    ...
    calls.push({
      ...
      providerRequestId: (r && r.providerRequestId) || null, localRequestId: (r && r.localRequestId) || null,
...
async function evaluateRelevanceEvidence(input) {
  ...
  return {
    ...
    inputsSha256: inputsHash, worksSubmitted: works.length,
