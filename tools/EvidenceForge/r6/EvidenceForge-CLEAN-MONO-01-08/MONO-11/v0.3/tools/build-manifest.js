...
const t = cp.spawnSync("node", ["--test", "test/test-mono11-v0.3.js"], { cwd: LOT, encoding: "utf8", env: process.env });
...
const m = {
  lot: "MONO-11", version: "v0.3", name: "Autonomous Panel Successor — retry cible TARGET_REF_NOT_LITERAL (reparation ciblee du champ fautif, feedback deterministe par fragments, anti-repetition exacte, fail-closed inchange)", predecessor: { version: "v0.2", zipSha256: "5c208cbbd13231e732fe20475347f9f7cbe6f890f3ce4823581093c7eba60005", intact: true }, builtAt: new Date().toISOString(),
