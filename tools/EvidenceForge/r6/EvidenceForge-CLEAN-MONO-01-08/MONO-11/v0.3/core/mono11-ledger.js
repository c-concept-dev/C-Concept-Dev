"use strict";
/**
 * MONO-11 v0.2 — core/mono11-ledger.js
 *
...
function openMono11Ledger(input) {
  ...
  const anchor = { runId: manifest.runId, missionHash: manifest.missionHash, attestationHash: manifest.runtimeAttestationHash,
    ...
    /* v0.2 — le sceau du lot qui EXECUTE est epingle dans l'ancre (mandat §1) */
    runtimeSeal: input.sealInfo ? { mono11Version: input.sealInfo.mono11Version, runtimeSealSha256: input.sealInfo.runtimeSealSha256, runCodeHash: input.sealInfo.runCodeHash,
      mono11ManifestSha256: input.sealInfo.mono11ManifestSha256, mono11ZipSha256: input.sealInfo.mono11ZipSha256 } : null };
  ...
  return Object.freeze({
    ...
    /** v0.2 — tous les artefacts enregistres, pour persistance (aucun secret n'y entre : ce sont des preuves). */
    exportArtifacts() { const out = {}; byId.forEach((e, id) => { out[id] = { kind: e.kind, sha256: e.hash, artifact: e.artifact }; }); return out; },
