  ...
  const p = (async function () {
    ...
    try {
      ...
      if (!isDone("QUALIFICATION")) {
        ...
        const ef03b = adapter.stats(); r.summary.ef03b = ef03b; store.saveJson("ef03b-resilience.json", Object.assign({ schema: "EvidenceForge.EF03BResilienceSummary", schemaVersion: "MONOLITH-v1.0.10", attemptId: state.attempts }, ef03b));   /* v1.0.10 : reuse registre / troncatures / completions / litteralisations / cout cumule des revues */
