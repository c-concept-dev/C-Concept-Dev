 ...
 * PREUVE D'INTEGRATION : importe, EN LECTURE SEULE, un run MONO-11 deja produit et scelle sous le zip declare par la config (ex. P0.1 seal B) comme run du
...
function main() {
  ...
  report.importedFrom = state.importedFrom; /* hors du hash canonique (HASH_EXCLUDED) : verifyReportHash reste vrai */ store.saveJson("report.json", report);
