...
function createReviewRegistry(opts) {
  ...
  function put(entry) { fs.mkdirSync(opts.runDir, { recursive: true }); fs.appendFileSync(file, JSON.stringify(Object.assign({ schema: "EvidenceForge.ValidReviewRecord", schemaVersion: "MONOLITH-v1.0.15", status: "VALID", recordedAt: new Date().toISOString() }, entry)) + "\n"); return entry; }
