...
test("recovery-route utilise le contrat createLink sans bloquer l'initialisation", () => {
  ...
  load(fileURLToPath(new URL("../src/core/peripheral-registry.js", import.meta.url)), context);
  load(fileURLToPath(new URL("../src/core/recovery-route-core.js", import.meta.url)), context);
  load(fileURLToPath(new URL("../src/peripherals/recovery-route-provider.js", import.meta.url)), context);
