...
const BASE = '/tmp/claude-0/-home-user-C-Concept-Dev/5f3425ee-5b94-52ca-aae3-c1f5a0b05cc9/scratchpad/real-repo-check';
const FILE = BASE + '/tools/Projet therapeutes/Conseiller Clinique/studio-clinique.html';
...
(async () => {
  ...
  const bodyText = await page.evaluate(() => document.body.innerText.slice(0, 200)).catch(() => '(échec lecture body)');
  console.log('extrait du contenu de la page atteinte:', bodyText.replace(/\n+/g, ' ').trim());
