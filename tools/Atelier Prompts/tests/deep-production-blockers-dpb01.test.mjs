...
/* V2 — CES TESTS CARACTÉRISENT LE PLAN HISTORIQUE, et ils doivent continuer de le faire :
   Analyste → Critique → Arbitre reste supporté comme retour arrière. Le plan NOMINAL est désormais
   `core` ; ce pin dit donc ce que ce fichier mesure, au lieu de le laisser dépendre d'un défaut. */
const ENV = { ALLOWED_ORIGINS: 'https://atelier.example.com', ANTHROPIC_API_KEY: 'clef-serveur' , ATELIER_NOMINAL_PLANE: 'legacy' };
