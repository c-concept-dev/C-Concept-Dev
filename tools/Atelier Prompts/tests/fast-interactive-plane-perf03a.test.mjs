...
test('T-P03A-10 la forme rendue au consommateur est indépendante du fournisseur', () => {
  ...
  assert.deepEqual(Object.keys(interaction).sort(),
    ['authority', 'can_execute', 'can_mark_ready', 'can_route', 'canonical_version', 'explicit_unknown_determinant_ids', 'interaction_id', 'missing_determinant_id', 'question_focus', 'source', 'text', 'turn_id', 'type']);
