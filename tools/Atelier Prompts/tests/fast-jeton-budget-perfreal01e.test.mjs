...
test('T-PERFREAL01E-15 : aucune réduction n’a été appliquée, et le plancher dit pourquoi', () => {
   ...
   * contenu qui varie et une production qui change (→ 3 178 caractères).
   *
  ...
  assert.equal(FAST_INTERACTION_SYSTEM_PROMPT.length, 3178,
...
test('T-PERFREAL01E-14 : l’artefact frontend n’a pas bougé, et l’observation ne décide rien', () => {
  ...
  assert.equal(crypto.createHash('sha256').update(octets).digest('hex'),
    'a5eeceea201287724127511240234fbb9af024fa43ce18b69289bdb5f48cc6ce', 'CANONICAL_HTML_CHANGED = NO');
