...
test('T-CLEAN04-01 : chaque module embarqué est atteignable depuis un chemin produit', () => {
  ...
  /* V2 — DEUX MODULES DE PLUS, ET LEUR RAISON. `SOLICIT` porte la définition unique de
     l'atomicité d'une question ; `COREPLANE` porte le chemin nominal V2. Tous deux sont importés
...
test('T-CLEAN04-05 : un seul graphe de build, et il ne diverge pas des imports réels', () => {
  ...
  assert.deepEqual(outils.sort(), ['build-adn-browser-runtime.mjs', 'build-document-assets.mjs', 'build-release-manifest.mjs',
    'frozen-guard.mjs']);
