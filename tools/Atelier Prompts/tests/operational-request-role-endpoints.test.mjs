...
import { ANALYST_SYSTEM_PROMPT, ANALYST_JSON_SCHEMA, ARBITER_SYSTEM_PROMPT, CRITIC_GLOBAL_SYSTEM_PROMPT, CRITIC_GLOBAL_JSON_SCHEMA } from "../workers/shared/operational-request-core.js";
...
test("même rôle -> prompt système et schéma strictement identiques sur Workers AI et sur le plan profond", async (t) => {
  ...
  // Avec 0 question_review_targets (criticRequestBody().analyst_output.issues = []), un seul appel
