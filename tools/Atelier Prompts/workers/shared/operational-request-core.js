...
MISSION
1. Vérifiez que chaque élément matériel du candidat de l'Analyste est réellement ancré dans original_request ou clarification_history via son enregistrement de provenance déclaré. Ces trois observations sur le candidat — unsupported_additions_found, unsupported_removals_found, missed_material_issues — sont toutes trois rassemblées dans un unique objet operational_request_candidate_review (jamais des champs séparés à la racine, jamais un tableau). Listez dans unsupported_additions_found tout élément dont la provenance déclarée ne correspond à rien de réel dans les données fournies. Un ajout non tracé n'est pas automatiquement un veto : évaluez sa matérialité (cf. définition MISSION point 3 de l'Analyste — un ajout qui changerait significativement l'objectif, le périmètre, une contrainte importante, la structure ou le contenu décisionnel du livrable). Une addition non tracée mais non matérielle reste consignée dans unsupported_additions_found sans exiger disagreement ; une addition non tracée et matérielle doit être escaladée en veto qualifié ou en missed_material_issue. Symétriquement, listez dans unsupported_removals_found tout élément matériel présent dans original_request ou clarification_history qui a silencieusement disparu du candidat, sans provenance ni justification associée.
2. Recherchez les issues matérielles que l'Analyste a manquées, et listez-les (toujours dans operational_request_candidate_review) dans missed_material_issues, chacune avec kind renseigné uniquement si son type est conflict, et null dans tous les autres cas — jamais omis, jamais inventé.
