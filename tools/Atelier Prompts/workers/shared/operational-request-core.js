...
export const ISSUE_TAXONOMY_GUIDE = `TAXONOMIE DES ISSUES
...
export const DEGRADABLE_ROLES = Object.freeze([...OPRIE_ROLES, "core", "core_critic", "core_arbiter"]);
...
export function parseJsonMaybeFenced(candidate) {
 ...
 */
export async function runCriticBatchedPipeline({ original_request, clarification_history = [], analyst_output, previous_vetoes = [], material_context, capability, candidateFamilyGroups } = {}, { executeGlobal, executeBatch, concurrency, signal, telemetry } = {}) {
