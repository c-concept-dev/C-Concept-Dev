 ...
 * source-sha256: 6ae74b8c8dcf961145569690b24debaa868778893161f7971cec46988d49c45f
 ...
 */
function reduceQuestionDeterministically(texte) {
  const t = String(texte || '').trim();
  if (!t) return null;
  const essais = [];
